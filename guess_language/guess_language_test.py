...
from guess_language import (createOrderedModel, find_runs,
                            guessLanguage, guessLanguageName,
                            guessLanguageTag, guessLanguageId,
                            guessLanguageInfo, normalize, UNKNOWN)
...
class guess_language_test(unittest.TestCase):
    def test_normalize(self):
        ...
        print
        print "Unnormalized: %r" % s
        print "Normalized:   %r" % normalize(s)
